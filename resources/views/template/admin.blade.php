            ...
            <ul class="sidebar-menu" id="sidebar-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="{{ route('data-product') }}"><i
                                    class="ri-circle-fill circle-icon text-secondary-600 w-auto"></i> Product List</a>
                        </li>
                        <li>
                            <a href="{{ route('history-stock') }}"><i
                ...
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        ...
                        <li>
                            <a href="{{ route('order-shipping') }}"><i
                                    class="ri-circle-fill circle-icon text-secondary-main w-auto"></i> Order
                                Shipping</a>
                        </li>
                        <li>
                            <a href="{{ route('order-log') }}"><i
                                    class="ri-circle-fill circle-icon text-secondary-main w-auto"></i> Log Order</a>
                        </li>
                    </ul>
                </li>
        ...
        <footer class="d-footer">
            <div class="row align-items-center justify-content-between">
                <div class="col-auto text-center">
                    <p class="mb-0">© 2025 TeckD'or. All Rights Reserved.</p>
                </div>
                {{-- <div class="col-auto">
